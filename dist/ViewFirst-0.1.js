...
(function() {
  ...
  define('ViewFirstEvents',[],function() {
    var ViewFirstEvents;
...
(function() {
  ...
  define('Property',["underscore", "ViewFirstEvents"], function(_, Events) {
    var Property;
...
(function() {
  ...
  define('AtmosphereSynchronization',["jquery", "underscore"], function($, _) {
    /*
...
(function() {
  ...
  define('ViewFirstModelContainer',["ViewFirstEvents"], function(Events) {
...
(function() {
  ...
  define('BindHelpers',["underscore"], function(_) {
    var BindHelpers;
...
(function() {
  ...
  define('TemplatingSnippets',[], function() {
...
(function() {
  ...
  define('OneToMany',["underscore"], function(_) {
    var OneToMany;
...
(function() {
  ...
  define('ViewFirstConverters',["moment"], function(moment) {
    var ViewFirstConverters;
    return ViewFirstConverters = function(viewFirst) {
...
(function() {
  ...
  define('ViewFirst',["ViewFirstModel", "ViewFirstRouter", "ViewFirstModelContainer", "BindHelpers", "TemplatingSnippets", "OneToMany", "ManyToOne", "ViewFirstConverters"], function(ViewFirstModel, ViewFirstRouter, ModelContainer, BindHelpers, TemplatingSnippets, OneToMany, ManyToOne, ViewFirstConverters) {
    var ViewFirst;
