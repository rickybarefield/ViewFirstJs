...
(function() {
  ...
  define(["ViewFirstModel", "ViewFirst", "Property", "House", "Postman", "Room", "expect", "mocha", "sinon", "sandbox", "underscore", "jquery"], function(ViewFirstModel, ViewFirst, Property, House, Postman, Room, expect, mocha, sinon, sandbox, _, $) {
    ...
    return suite('ViewFirst Tests', function() {
      ...
      setup(function() {
        ...
        $('#testDiv').html("");
        return viewFirst.initialize("ws://server.websocket.address", "basicView");
      });
      teardown(function() {
