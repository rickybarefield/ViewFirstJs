  ...
  define(function() {
    ...
    return ViewFirstRouter = (function() {
      ...
      deriveNamedModelString = function(namedModels) {
        var container, name, namedModelStrings, _results;
        _results = [];
        for (name in namedModels) {
          container = namedModels[name];
          if (container.model.isPersisted) {
            _results.push(namedModelStrings = "" + name + "=" + (container.model.get("id")));
          }
        }
        return _results;
      };
      ...
      ViewFirstRouter.prototype.update = function() {
        ...
        return history.pushState(null, null, "" + this.baseUrl + "#" + this.viewFirst.currentView);
      };
