  ...
  window.ViewFirst = (function() {
    ...
    */
    ...
    ViewFirst._bindParts = function(surroundingContent, nodes) {
      ...
      for (_i = 0, _len = nodes.length; _i < _len; _i++) {
        ...
        if (at != null) {
          _results.push(this._bind(surroundingContent, child.childNodes, at));
        } else {
    ...
    */
    ...
    ViewFirst.prototype.bindNodeValues = function(node, model) {
      var _this = this;
      return ViewFirst.doForNodeAndChildren(node, function(aNode) {
        var property;
    ...
    ViewFirst.doForNodeAndChildren = function(node, func) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        childNode = _ref[_i];
        _results.push(ViewFirst.doForNodeAndChildren($(childNode), func));
      }
      return _results;
    };
